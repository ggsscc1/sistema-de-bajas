...
def ventana_Formulario(fila_seleccionada):
    ...
    etiqueta_correo = customtkinter.CTkLabel(frame_central, text="Si trabaja nombre de la empresa:", fg_color="white", anchor="w", font=("Arial",16))
    etiqueta_correo.grid(row=13, column=0, sticky="w", padx=20, pady=10)
    etiqueta_valor_correo = customtkinter.CTkEntry(frame_central,width=250, corner_radius=10, textvariable=trabajoF)
    etiqueta_valor_correo.grid(row=13, column=1, padx=20, pady=10) 
    ...
    forma_titulacion_label = customtkinter.CTkLabel(frame_central, text="Forma de Titulación:", fg_color="white", anchor="w", font=("Arial", 16))
    ...
    # Función para mostrar u ocultar "Forma de Titulación"
    def mostrar_forma_titulacion():
        print("Función mostrar_forma_titulacion ejecutada")
        motivo_baja = motivo_bajaF.get()
        if motivo_baja == 'Titulación':
            forma_titulacion_label.grid(row=2, column=2, sticky="w", padx=20, pady=10)
            forma_titulacion_entry.grid(row=2, column=3, padx=20, pady=10)
        else:
            forma_titulacion_label.grid_remove()
    ...
    # Configurar la función de control de eventos
    motivo_bajaF.trace("w", lambda *args: mostrar_forma_titulacion())
