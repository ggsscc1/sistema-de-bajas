...
def haz_consulta():
    ...
    # Agregar botón de exportar a Excel
    btn_Gen = Button(ventana_resultados, text="Grafica Generacion", command=lambda:consultaG.consulta_generacion2(results))
    btn_Gen.pack()

    # Agregar botón de exportar a Excel
    btn_Carrera = Button(ventana_resultados, text="Grafica Carrera", command=lambda:consultaG.consulta_carrera2(results))
    btn_Carrera.pack()

    # Agregar botón de exportar a Excel
    btn_escuela = Button(ventana_resultados, text="Grafica escuela", command=exportar_a_excel)
    btn_escuela.pack()

    # Agregar botón de exportar a Excel
    btn_tramite = Button(ventana_resultados, text="Grafica tramite", command=exportar_a_excel)
    btn_tramite.pack()

    # Agregar botón de exportar a Excel
    btn_Mat = Button(ventana_resultados, text="Materia dificil", command=exportar_a_excel)
    btn_Mat.pack()
...
def emergente_consulta():
    ...
    ventana_emergente.title("Sistema de bajas de CiComp - Generar consulta")
    ...
    global anioC, generacionC, carreraC, tipoC, motivoC, materiaC, escuelaC
    ...
    BuscarAnio = ttk.Combobox(ventana_emergente, state="readonly", textvariable=anioC)
    BuscarAnio.place(x=85, y=70)
    ...
    BuscarGen = ttk.Combobox(ventana_emergente, state="readonly", textvariable=generacionC)
    BuscarGen.place(x=85, y=100)
